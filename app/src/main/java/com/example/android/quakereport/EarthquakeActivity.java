...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EarthquakeTask mEarthquakeTask = new EarthquakeTask();
        mEarthquakeTask.execute(USGS_REQUEST_URL);
    }
    ...
    private void updateUi(List<Earthquake> earthquakes) {
        ...
        // Set a click listener to open the USGS web page to see additional details on that earthquake
